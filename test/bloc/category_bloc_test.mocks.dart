...
class MockCategoryRepository extends _i1.Mock
  ...
  _i3.Stream<List<_i4.CategoryModel>> findActive({required String? userId}) =>
      (super.noSuchMethod(
            Invocation.method(#findActive, [], {#userId: userId}),
  ...
  @override
  _i3.Stream<int?> count({required String? userId}) =>
      (super.noSuchMethod(
            Invocation.method(#count, [], {#userId: userId}),
  ...
  _i3.Future<List<_i4.CategoryModel>> findByName({
    ...
    String? name,
      ...
      (super.noSuchMethod(
            Invocation.method(#findByName, [], {#userId: userId, #name: name}),
            returnValue: _i3.Future<List<_i4.CategoryModel>>.value(
              <_i4.CategoryModel>[],
            ),
          )
  ...
  _i3.Future<_i4.CategoryModel?> toggleActive({
    ...
    required bool? active,
      ...
      (super.noSuchMethod(
            Invocation.method(#toggleActive, [], {
              #userId: userId,
              #categoryId: categoryId,
              #active: active,
            }),
...
class MockStorageService extends _i1.Mock implements _i5.StorageService {
  ...
  @override
  _i3.Future<void> delete({required String? path}) =>
      (super.noSuchMethod(
            Invocation.method(#delete, [], {#path: path}),
